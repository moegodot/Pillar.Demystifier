    ...
    public class NonThrownException
    {
        ...
        public async Task DoesNotPreventThrowStackTrace()
        {
            ...
            var demystifiedException = new Exception(innerException.Message, innerException)
                .Demystify(StyledBuilderOption.NoColorOption);
            ...
            Assert.Equal(
                new[] {     
                    ...
                    " ---> System.Exception: Exception of type 'System.Exception' was thrown.",
                    "   at Task Pillar.Demystifier.Test.NonThrownException.DoesNotPreventThrowStackTrace()+() => { }",
                    "   at async Task Pillar.Demystifier.Test.NonThrownException.DoesNotPreventThrowStackTrace()",
