...
namespace Pillar.Demystifier.Test
{
    ...
    public class MethodTests
    {
        ...
        public void DemistifiesMethodWithNullableInt()
        {
            ...
            {
                dex = e.Demystify(StyledBuilderOption.NoColorOption);
            }
            ...
            var expected = string.Join(string.Empty,
                ...
                "   at bool Pillar.Demystifier.Test.MethodTests.MethodWithNullableInt(int? number)",
                "   at void Pillar.Demystifier.Test.MethodTests.DemistifiesMethodWithNullableInt()");
        ...
        public void DemistifiesMethodWithDynamic()
        {
            ...
            var expected = string.Join(string.Empty,
                "System.ArgumentException: Value does not fall within the expected range.",
                "   at bool Pillar.Demystifier.Test.MethodTests.MethodWithDynamic(dynamic value)",
                "   at void Pillar.Demystifier.Test.MethodTests.DemistifiesMethodWithDynamic()");
        ...
        public void DemistifiesMethodWithLambda()
        {
            ...
            var expected = string.Join(string.Empty,
                "System.ArgumentException: Value does not fall within the expected range.",
                "   at void Pillar.Demystifier.Test.MethodTests.MethodWithLambda()+() => { }",
                "   at void Pillar.Demystifier.Test.MethodTests.MethodWithLambda()",
                "   at void Pillar.Demystifier.Test.MethodTests.DemistifiesMethodWithLambda()");
        ...
        public async Task DemistifiesMethodWithAsyncLambda()
        {
            ...
            var expected = string.Join(string.Empty,
                "System.ArgumentException: Value does not fall within the expected range.",
                "   at async Task Pillar.Demystifier.Test.MethodTests.MethodWithAsyncLambda()+(?) => { }",
                "   at async Task Pillar.Demystifier.Test.MethodTests.MethodWithAsyncLambda()",
                "   at async Task Pillar.Demystifier.Test.MethodTests.DemistifiesMethodWithAsyncLambda()");
