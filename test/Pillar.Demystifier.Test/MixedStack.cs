...
namespace Pillar.Demystifier.Test
{
    public class MixedStack
    {
        ...
        {
            "IEnumerable<string> Pillar.Demystifier.Test.MixedStack.Iterator()+MoveNext()",
            "string string.Join(string separator, IEnumerable<string> values)",
            "string Pillar.Demystifier.Test.MixedStack+GenericClass<T>.GenericMethod<V>(ref V value)",
            "async Task<string> Pillar.Demystifier.Test.MixedStack.MethodAsync(int value)",
            "async ValueTask<string> Pillar.Demystifier.Test.MixedStack.MethodAsync<TValue>(TValue value)",
            "(string val, bool) Pillar.Demystifier.Test.MixedStack.Method(string value)",
            "ref string Pillar.Demystifier.Test.MixedStack.RefMethod(string value)",
            "(string val, bool) Pillar.Demystifier.Test.MixedStack.s_func(string s, bool b)",
            "void Pillar.Demystifier.Test.MixedStack.s_action(string s, bool b)",
            "void Pillar.Demystifier.Test.MixedStack.Start((string val, bool) param)"
