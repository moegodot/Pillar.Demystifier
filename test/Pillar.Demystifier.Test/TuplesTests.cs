    ...
    public class TuplesTests
    {
        ...
        public void DemistifiesAsyncMethodWithTuples()
        {
            ...
            var expected = string.Join("", new[] {
                    ...
                    "   at async Task<(int left, int right)> Pillar.Demystifier.Test.TuplesTests.AsyncThatReturnsTuple()",
                    "   at void Pillar.Demystifier.Test.TuplesTests.DemistifiesAsyncMethodWithTuples()"});
        ...
        public void DemistifiesListOfTuples()
        {
            ...
            var expected = string.Join("", new[] {
                    "System.ArgumentException: Value does not fall within the expected range.",
                    "   at List<(int left, int right)> Pillar.Demystifier.Test.TuplesTests.ListOfTuples()",
                    "   at void Pillar.Demystifier.Test.TuplesTests.DemistifiesListOfTuples()"});
