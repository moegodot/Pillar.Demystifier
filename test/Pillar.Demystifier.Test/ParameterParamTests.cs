    ...
    public class ParameterParamTests
    {
        ...
        public void DemistifiesMethodWithParams()
        {
            ...
            var expected = string.Join(string.Empty, new[] {
                ...
                "   at bool Pillar.Demystifier.Test.ParameterParamTests.MethodWithParams(params int[] numbers)",
                "   at void Pillar.Demystifier.Test.ParameterParamTests.DemistifiesMethodWithParams()"});
