    ...
    public class AsyncEnumerableTests
    {
        ...
        public async Task DemystifiesAsyncEnumerable()
        {
            ...
            var expected = string.Join("", new[] {
                "   at async IAsyncEnumerable<int> Pillar.Demystifier.Test.AsyncEnumerableTests.Throw(CancellationToken cancellationToken)+MoveNext()",
                "   at async IAsyncEnumerable<long> Pillar.Demystifier.Test.AsyncEnumerableTests.Start(CancellationToken cancellationToken)+MoveNext() x N",
                "   at async Task Pillar.Demystifier.Test.AsyncEnumerableTests.DemystifiesAsyncEnumerable() x N"
            });
